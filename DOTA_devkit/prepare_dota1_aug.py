...
def parse_args():
    ...
    parser.add_argument('--srcpath', default='/home/gqx/GQX/AerialDetection/data/dota')
    parser.add_argument('--dstpath', default=r'/home/gqx/GQX/AerialDetection/data/dota_aug_1_25',
                        help='prepare data')
