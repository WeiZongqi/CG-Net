...
def parse_args():
    ...
    parser.add_argument('--srcpath', default='/home/wzq/datasets/dota/dota_tmp')
    parser.add_argument('--dstpath', default=r'/home/wzq/datasets/dota/dota_tmp-split-1024',
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    split_train = ImgSplit_multi_process.splitbase(os.path.join(srcpath, ''),
