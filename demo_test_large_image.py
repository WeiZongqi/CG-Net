...
if __name__ == '__main__':
    roitransformer = DetectorModel(r'configs/DOTA/faster_rcnn_RoITrans_r50_fpn_selfatten6_1_1x_dota_test.py',
                  r'work_dirs/faster_rcnn_RoITrans_r50_fpn_selfatten6_1_1x_dota_test/epoch_12.pth')

    # roitransformer.inference_single_vis(r'demo/P0009.jpg',
    #                                    r'demo/P0009_out.jpg',
    #                                     (512, 512),
    #                                    (1024, 1024))
    img_path ='/home/wzq/datasets/dota/dota_select/images'
    # img_path = '/home/cver/data/GQX/AerialDetection/data/dota/test/images'
    img_out_path = '/home/wzq/datasets/dota/dota_select/test_out_r50_selfatten6_1'
