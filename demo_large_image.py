...
if __name__ == '__main__':
    # roitransformer = DetectorModel(r'configs/DOTA/faster_rcnn_RoITrans_r101_fpn_1x_dota.py',
    #               r'work_dirs/faster_rcnn_RoITrans_r101_fpn_1x_dota/epoch_12.pth')

    roitransformer = DetectorModel(r'configs/DOTA/faster_rcnn_RoITrans_r50_fpn_selfatten6_1_1x_dota.py',
                                   r'work_dirs/faster_rcnn_RoITrans_r50_fpn_selfatten6_1_1x_dota/epoch_12.pth')

    # roitransformer = DetectorModel(r'configs/DOTA/faster_rcnn_RoITrans_r101_fpn_selfatten6_5_rotate_lr0008_4.py',
    #                                r'work_dirs/faster_rcnn_RoITrans_r101_fpn_selfatten6_5_rotate_lr0008_4/epoch_12.pth')

    roitransformer.inference_single_vis(r'demo/images/P0089.png',
                                       r'demo/transformer/P0089_out1.png',
                                        (512, 512),
                                       (1024, 1024))

    # filename = ['P0073.png','P0089.png','P0135.png','P0153.png','P0316.png','P0318.png','P0449.png','P0661.png','P1115.png']
    # for img in filename:
    #     # print(img_path + '/' + img)
    #     # print(img_out_path + '/' + img.split('.')[0] + '_out.jpg')
    #     roitransformer.inference_single_vis(r'demo/images/'+img,
    #                                         r'demo/transformer/'+img.replace('.png','_out.png'),
    #                                         (512, 512),
    #                                         (1024, 1024))
